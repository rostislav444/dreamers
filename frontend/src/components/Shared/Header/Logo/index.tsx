  ...
  return (
    <Flex justifyContent='center' alignItems='center'>
      ...
      <Flex position='relative' w='12' h='12'>
        <Image animation={animation1} pos='absolute' top='4' left='1' w='9' h='9' src={imageUrl} />
        <Image animation={animation2} pos='absolute' top='-1' left='6' w='6' h='6' src={imageUrl} />
        <Image animation={animation3} pos='absolute' top='2' w='4' h='4' src={imageUrl} />
      </Flex>
    </Flex>
  );
};
