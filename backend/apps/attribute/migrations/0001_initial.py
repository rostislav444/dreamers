    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'abstract': False,
                'unique_together': {('group', 'value_text'), ('group', 'value_float'), ('group', 'value_boolean'), ('group', 'value_color_name', 'value_color_hex', 'value_color_image'), ('group', 'value_integer'), ('group', 'value_min', 'value_max')},
            },
        ),
        migrations.CreateModel(
            name='AttributeUnit',
            ...
            options={
                ...
                'unique_together': {('unit', 'attribute', 'value_float'), ('unit', 'attribute', 'value_int'), ('unit', 'attribute')},
            },
        ),
    ]
