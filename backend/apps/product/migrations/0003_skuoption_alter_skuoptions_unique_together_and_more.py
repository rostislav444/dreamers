# Generated by Django 4.0 on 2022-08-03 10:52
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('product', '0002_alter_productclassoption_value_attribute'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            options={
                ...
                'unique_together': {('group', 'value_attribute'), ('group', 'value_boolean'), ('group', 'value_float'), ('group', 'value_min', 'value_max'), ('group', 'value_integer'), ('group', 'value_color_name', 'value_color_hex', 'value_color_image'), ('group', 'value_text')},
            },
        ),
        ...
        migrations.RenameModel(
            old_name='ProductAttributeOptionImage',
            new_name='SkuOptionImage',
        ),
        ...
        migrations.AlterField(
            model_name='skuoptionimage',
            name='product_option',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='product.skuoption'),
        ),
    ]
